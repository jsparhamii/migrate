...
def main():
    # arguments 
    parser = argparse.ArgumentParser(description='Create sample jobs log')
    parser.add_argument('--jobs', nargs='+', type=int, help='list of job ids to sample')
    parser.add_argument('--logs', type=str, help='path to logs folder', default="logs/session/") # path to logs folder 
